...
//        optimized: false
    ...
    var mcOptions = {gridSize: 50, maxZoom: 14, zoomOnClick: true, styles:style};
...
function getIconForLocation(location) {
    ...
    if (location)
	{
		if (location.type == 'alert')
		{
        	icon = location.alertType ? location.alertType.charAt(0).toUpperCase() + location.alertType.substr(1).toLowerCase() + 'Pin.png' : icon;

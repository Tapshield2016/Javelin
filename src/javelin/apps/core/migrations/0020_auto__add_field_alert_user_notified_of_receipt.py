...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alert.user_notified_of_receipt'
        db.add_column(u'core_alert', 'user_notified_of_receipt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alert.user_notified_of_receipt'
        db.delete_column(u'core_alert', 'user_notified_of_receipt')

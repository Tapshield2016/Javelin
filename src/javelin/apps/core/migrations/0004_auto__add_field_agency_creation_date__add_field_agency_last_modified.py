...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.creation_date'
        db.add_column(u'core_agency', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 22, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Agency.last_modified'
        db.add_column(u'core_agency', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 22, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.creation_date'
        db.delete_column(u'core_agency', 'creation_date')

        # Deleting field 'Agency.last_modified'
        db.delete_column(u'core_agency', 'last_modified')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgencyUser.last_reported_latitude'
        db.add_column(u'core_agencyuser', 'last_reported_latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'AgencyUser.last_reported_longitude'
        db.add_column(u'core_agencyuser', 'last_reported_longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'AgencyUser.last_reported_point'
        db.add_column(u'core_agencyuser', 'last_reported_point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(blank=True, null=True, geography=True),
                      keep_default=False)

        # Adding field 'AgencyUser.last_reported_time'
        db.add_column(u'core_agencyuser', 'last_reported_time',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AgencyUser.last_reported_latitude'
        db.delete_column(u'core_agencyuser', 'last_reported_latitude')

        # Deleting field 'AgencyUser.last_reported_longitude'
        db.delete_column(u'core_agencyuser', 'last_reported_longitude')

        # Deleting field 'AgencyUser.last_reported_point'
        db.delete_column(u'core_agencyuser', 'last_reported_point')

        # Deleting field 'AgencyUser.last_reported_time'
        db.delete_column(u'core_agencyuser', 'last_reported_time')
    ...
    models = {
        ...
        u'core.agencyuser': {
            ...
            'last_reported_latitude': ('django.db.models.fields.FloatField', [], {}),
            'last_reported_longitude': ('django.db.models.fields.FloatField', [], {}),

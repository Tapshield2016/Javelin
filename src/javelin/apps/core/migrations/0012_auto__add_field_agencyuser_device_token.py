...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgencyUser.device_token'
        db.add_column(u'core_agencyuser', 'device_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgencyUser.device_token'
        db.delete_column(u'core_agencyuser', 'device_token')

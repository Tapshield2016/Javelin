...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Agency.default_map_zoop_level'
        db.delete_column(u'core_agency', 'default_map_zoop_level')

        # Adding field 'Agency.default_map_zoom_level'
        db.add_column(u'core_agency', 'default_map_zoom_level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=15),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Agency.default_map_zoop_level'
        db.add_column(u'core_agency', 'default_map_zoop_level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=15),
                      keep_default=False)

        # Deleting field 'Agency.default_map_zoom_level'
        db.delete_column(u'core_agency', 'default_map_zoom_level')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.dispatcher_secondary_phone_number'
        db.add_column(u'core_agency', 'dispatcher_secondary_phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=24, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.dispatcher_secondary_phone_number'
        db.delete_column(u'core_agency', 'dispatcher_secondary_phone_number')

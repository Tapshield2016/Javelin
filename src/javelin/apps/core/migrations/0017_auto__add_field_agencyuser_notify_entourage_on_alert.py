...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgencyUser.notify_entourage_on_alert'
        db.add_column(u'core_agencyuser', 'notify_entourage_on_alert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgencyUser.notify_entourage_on_alert'
        db.delete_column(u'core_agencyuser', 'notify_entourage_on_alert')

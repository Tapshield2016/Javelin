...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agency.agency_boundaries'
        db.alter_column(u'core_agency', 'agency_boundaries', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Agency.agency_boundaries'
        db.alter_column(u'core_agency', 'agency_boundaries', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(default=''))

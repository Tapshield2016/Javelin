...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.alert_received_message'
        db.add_column(u'core_agency', 'alert_received_message',
                      self.gf('django.db.models.fields.CharField')(default='The authorities have been notified.', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.alert_received_message'
        db.delete_column(u'core_agency', 'alert_received_message')

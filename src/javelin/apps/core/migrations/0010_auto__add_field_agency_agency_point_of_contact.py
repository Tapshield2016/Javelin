...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.agency_point_of_contact'
        db.add_column(u'core_agency', 'agency_point_of_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=9, related_name='agency_point_of_contact', to=orm['core.AgencyUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.agency_point_of_contact'
        db.delete_column(u'core_agency', 'agency_point_of_contact_id')
    ...
    models = {
        ...
        u'core.agency': {
            ...
            'agency_point_of_contact': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agency_point_of_contact'", 'to': u"orm['core.AgencyUser']"}),
        ...
        u'core.chatmessage': {
            'Meta': {'ordering': "['creation_date']", 'object_name': 'ChatMessage'},

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgencyUser.phone_number_verification_code'
        db.add_column(u'core_agencyuser', 'phone_number_verification_code',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgencyUser.phone_number_verification_code'
        db.delete_column(u'core_agencyuser', 'phone_number_verification_code')

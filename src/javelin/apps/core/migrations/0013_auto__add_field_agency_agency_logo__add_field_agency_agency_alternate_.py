...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.agency_logo'
        db.add_column(u'core_agency', 'agency_logo',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agency.agency_alternate_logo'
        db.add_column(u'core_agency', 'agency_alternate_logo',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agency.agency_small_logo'
        db.add_column(u'core_agency', 'agency_small_logo',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agency.agency_theme'
        db.add_column(u'core_agency', 'agency_theme',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.agency_logo'
        db.delete_column(u'core_agency', 'agency_logo')

        # Deleting field 'Agency.agency_alternate_logo'
        db.delete_column(u'core_agency', 'agency_alternate_logo')

        # Deleting field 'Agency.agency_small_logo'
        db.delete_column(u'core_agency', 'agency_small_logo')

        # Deleting field 'Agency.agency_theme'
        db.delete_column(u'core_agency', 'agency_theme')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntourageSession'
        db.create_table(u'core_entouragesession', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),

            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='session_user', to=orm['core.AgencyUser'])),

            ('start_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='starting_locations', to=orm['core.NamedLocation'])),
            ('end_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ending_locations', to=orm['core.NamedLocation'])),
            ...
            ('entourage_notified', self.gf('django.db.models.fields.BooleanField')(default=False)),

            ('status', self.gf('django.db.models.fields.CharField')(default='T', max_length=1)),
        ))
        db.send_create_signal(u'core', ['EntourageSession'])

        # Adding model 'NamedLocation'
        db.create_table(u'core_namedlocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('address', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=255)),
        ))
        db.send_create_signal(u'core', ['NamedLocation'])

        # Adding model 'AlertLocation'
        db.create_table(u'core_trackinglocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('entourage_session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='session_user', to=orm['core.EntourageSession'])),
        ))
        db.send_create_signal(u'core', ['TrackingLocation'])


    def backwards(self, orm):

        db.delete_table(u'core_entouragesession')

        db.delete_table(u'core_trackinglocation')

        db.delete_table(u'core_namedlocation')
    ...
    models = {
        ...
        u'core.socialcrimereport': {
            ...
            'flagged_spam': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'viewed_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        u'core.userprofile': {
        ...
        u'core.region': {
            ...
            'radius': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        },
        ...
        u'core.staticdevice': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'unique': 'True'}),
        ...
        u'core.namedlocation': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'NamedLocation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'core.entouragesession': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'EntourageSession'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'session_user'", 'to': u"orm['core.AgencyUser']"}),

            'start_location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'starting_locations'", 'to': u"orm['core.NamedLocation']"}),
            'end_location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ending_locations'", 'to': u"orm['core.NamedLocation']"}),
            ...
            'entourage_notified': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'T'", 'max_length': '1'}),
        },
        u'core.trackinglocation': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'TrackingLocation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'entourage_session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'locations'", 'to': u"orm['core.EntourageSession']"}),
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MassAlert.address'
        db.add_column(u'core_massalert', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
        # Adding field 'MassAlert.latitude'
        db.add_column(u'core_massalert', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
        # Adding field 'MassAlert.longitude'
        db.add_column(u'core_massalert', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
        # Adding field 'MassAlert.type'
        db.add_column(u'core_massalert', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True))

    def backwards(self, orm):
        # Deleting field 'MassAlert.address'
        db.delete_column(u'core_massalert', 'address')
        # Deleting field 'MassAlert.latitude'
        db.delete_column(u'core_massalert', 'latitude')
        # Deleting field 'MassAlert.longitude'
        db.delete_column(u'core_massalert', 'longitude')
        # Deleting field 'MassAlert.type'
        db.delete_column(u'core_massalert', 'type')

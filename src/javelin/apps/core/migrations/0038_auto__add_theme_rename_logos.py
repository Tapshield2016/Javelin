...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'core_theme', 'logo', 'navbar_logo_alternate'),
        db.rename_column(u'core_theme', 'alternate_logo', 'map_overlay_logo'),\

        db.add_column(u'core_theme',
                      'navbar_logo', self.gf('core.aws.s3_filefield.S3EnabledImageField')(upload_to='file_path', blank=True, null=True)),

    def backwards(self, orm):
        # Rename 'full_name' field to 'name'
        db.rename_column(u'core_theme', 'map_overlay_logo', 'alternate_logo'),
        db.rename_column(u'core_theme', 'navbar_logo_alternate', 'logo'),
        db.delete_column(u'core_theme', 'navbar_logo')

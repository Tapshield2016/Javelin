...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Alert.location_accuracy'
        db.delete_column(u'core_alert', 'location_accuracy')

        # Deleting field 'Alert.location_altitude'
        db.delete_column(u'core_alert', 'location_altitude')

        # Deleting field 'Alert.locations'
        db.delete_column(u'core_alert', 'locations')

        # Deleting field 'Alert.location_longitude'
        db.delete_column(u'core_alert', 'location_longitude')

        # Deleting field 'Alert.location_latitude'
        db.delete_column(u'core_alert', 'location_latitude')

        # Deleting field 'Alert.location_address'
        db.delete_column(u'core_alert', 'location_address')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Alert.location_accuracy'
        db.add_column(u'core_alert', 'location_accuracy',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Alert.location_altitude'
        db.add_column(u'core_alert', 'location_altitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Alert.locations'
        db.add_column(u'core_alert', 'locations',
                      self.gf('django.contrib.gis.db.models.fields.MultiPointField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Alert.location_longitude'
        db.add_column(u'core_alert', 'location_longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Alert.location_latitude'
        db.add_column(u'core_alert', 'location_latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Alert.location_address'
        db.add_column(u'core_alert', 'location_address',

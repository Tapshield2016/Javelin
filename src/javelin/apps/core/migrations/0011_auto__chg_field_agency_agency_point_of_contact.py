...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agency.agency_point_of_contact'
        db.alter_column(u'core_agency', 'agency_point_of_contact_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.AgencyUser']))

    def backwards(self, orm):

        # Changing field 'Agency.agency_point_of_contact'
        db.alter_column(u'core_agency', 'agency_point_of_contact_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.AgencyUser']))

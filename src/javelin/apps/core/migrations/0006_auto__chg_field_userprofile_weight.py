...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.weight'
        db.alter_column(u'core_userprofile', 'weight', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.weight'
        db.alter_column(u'core_userprofile', 'weight', self.gf('django.db.models.fields.PositiveIntegerField')())

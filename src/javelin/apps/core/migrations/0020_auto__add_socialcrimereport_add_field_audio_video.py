...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialCrimeReport.agency_info_url'
        db.add_column(u'core_socialcrimereport', 'report_video_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
        
        # Adding field 'SocialCrimeReport.report_anonymous'
        db.add_column(u'core_socialcrimereport', 'report_audio_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

    def backwards(self, orm):
        # Deleting field 'SocialCrimeReport.report_anonymous'
        db.delete_column(u'core_socialcrimereport', 'report_video_url')
    
        # Deleting field 'SocialCrimeReport.report_anonymous'
        db.delete_column(u'core_socialcrimereport', 'report_audio_url')

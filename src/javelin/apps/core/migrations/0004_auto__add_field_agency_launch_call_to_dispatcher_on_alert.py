...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.launch_call_to_dispatcher_on_alert'
        db.add_column(u'core_agency', 'launch_call_to_dispatcher_on_alert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.launch_call_to_dispatcher_on_alert'
        db.delete_column(u'core_agency', 'launch_call_to_dispatcher_on_alert')

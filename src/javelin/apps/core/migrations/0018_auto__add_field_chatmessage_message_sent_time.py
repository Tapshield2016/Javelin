...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatMessage.message_sent_time'
        db.add_column(u'core_chatmessage', 'message_sent_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=django.utils.timezone.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChatMessage.message_sent_time'
        db.delete_column(u'core_chatmessage', 'message_sent_time')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.enable_chat_autoresponder'
        db.add_column(u'core_agency', 'enable_chat_autoresponder',
    ...
    def backwards(self, orm):
        # Deleting field 'Agency.enable_chat_autoresponder'
        db.delete_column(u'core_agency', 'enable_chat_autoresponder')

        # Deleting field 'Agency.chat_autoresponder_message'
        db.delete_column(u'core_agency', 'chat_autoresponder_message')
    ...
    models = {
        ...
        u'core.agency': {
            ...
            'chat_autoresponder_message': ('django.db.models.fields.TextField', [], {'default': "'Due to high volume, we are currently experiencing delays in responding to incoming messages. If you are in immediate need of emergency assistance, please dial 911.'", 'null': 'True', 'blank': 'True'}),

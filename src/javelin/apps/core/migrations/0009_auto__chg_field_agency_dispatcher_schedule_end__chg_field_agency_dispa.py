...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Agency.dispatcher_schedule_end'
        db.alter_column(u'core_agency', 'dispatcher_schedule_end', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Agency.dispatcher_schedule_start'
        db.alter_column(u'core_agency', 'dispatcher_schedule_start', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Agency.dispatcher_schedule_end'
        db.alter_column(u'core_agency', 'dispatcher_schedule_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Agency.dispatcher_schedule_start'
        db.alter_column(u'core_agency', 'dispatcher_schedule_start', self.gf('django.db.models.fields.DateTimeField')(null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ChatMessage', fields ['message_id']
        db.create_unique(u'core_chatmessage', ['message_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ChatMessage', fields ['message_id']
        db.delete_unique(u'core_chatmessage', ['message_id'])

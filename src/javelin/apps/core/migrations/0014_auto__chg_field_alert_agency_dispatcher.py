...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Alert.agency_dispatcher'
        db.alter_column(u'core_alert', 'agency_dispatcher_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.AgencyUser']))

    def backwards(self, orm):

        # Changing field 'Alert.agency_dispatcher'
        db.alter_column(u'core_alert', 'agency_dispatcher_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.AgencyUser']))

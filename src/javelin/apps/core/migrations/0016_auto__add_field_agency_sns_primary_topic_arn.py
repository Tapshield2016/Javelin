...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.sns_primary_topic_arn'
        db.add_column(u'core_agency', 'sns_primary_topic_arn',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.sns_primary_topic_arn'
        db.delete_column(u'core_agency', 'sns_primary_topic_arn')

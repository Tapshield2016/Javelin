...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.alert_mode_name'
        db.add_column(u'core_agency', 'alert_mode_name',
                      self.gf('django.db.models.fields.CharField')(default='Emergency', max_length=24),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.alert_mode_name'
        db.delete_column(u'core_agency', 'alert_mode_name')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AlertLocation.location_longitude'
        db.delete_column(u'core_alertlocation', 'location_longitude')

        # Deleting field 'AlertLocation.location_latitude'
        db.delete_column(u'core_alertlocation', 'location_latitude')

        # Deleting field 'AlertLocation.location_altitude'
        db.delete_column(u'core_alertlocation', 'location_altitude')

        # Deleting field 'AlertLocation.location_accuracy'
        db.delete_column(u'core_alertlocation', 'location_accuracy')

        # Adding field 'AlertLocation.accuracy'
        db.add_column(u'core_alertlocation', 'accuracy',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlertLocation.altitude'
        db.add_column(u'core_alertlocation', 'altitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlertLocation.latitude'
        db.add_column(u'core_alertlocation', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlertLocation.longitude'
        db.add_column(u'core_alertlocation', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AlertLocation.location_longitude'
        db.add_column(u'core_alertlocation', 'location_longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlertLocation.location_latitude'
        db.add_column(u'core_alertlocation', 'location_latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlertLocation.location_altitude'
        db.add_column(u'core_alertlocation', 'location_altitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlertLocation.location_accuracy'
        db.add_column(u'core_alertlocation', 'location_accuracy',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AlertLocation.accuracy'
        db.delete_column(u'core_alertlocation', 'accuracy')

        # Deleting field 'AlertLocation.altitude'
        db.delete_column(u'core_alertlocation', 'altitude')

        # Deleting field 'AlertLocation.latitude'
        db.delete_column(u'core_alertlocation', 'latitude')

        # Deleting field 'AlertLocation.longitude'
        db.delete_column(u'core_alertlocation', 'longitude')
    ...
    models = {
        ...
        u'core.alertlocation': {
            'Meta': {'object_name': 'AlertLocation'},

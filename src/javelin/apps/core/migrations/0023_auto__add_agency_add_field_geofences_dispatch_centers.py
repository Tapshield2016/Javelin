...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_region', (
            ...
            ('agency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='region', to=orm['core.Agency'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('boundaries', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('center_latitude', self.gf('django.db.models.fields.FloatField')()),
            ('center_longitude', self.gf('django.db.models.fields.FloatField')()),
            ('center_point', self.gf('django.contrib.gis.db.models.fields.PointField')(blank=True, null=True, geography=True)),

        ))
        db.send_create_signal(u'core', ['Region'])

        # Adding model 'Dispatch Center'
        db.create_table(u'core_dispatchcenter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dispatch_center', to=orm['core.Agency'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=24, null=True, blank=True)),

        ))
        db.send_create_signal(u'core', ['DispatchCenter'])

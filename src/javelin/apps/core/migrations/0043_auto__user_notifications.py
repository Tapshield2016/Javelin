...
class Migration(SchemaMigration):
    ...
    # action_object = generic.GenericForeignKey('content_type', 'object_id')
        ...
        db.create_table(u'core_usernotification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['core.AgencyUser'])),
            ...
            # ('action_object', self.gf('django.contrib.contenttypes.generic.GenericForeignKey')('content_type', 'object_id')),
        ))
        db.send_create_signal(u'core', ['UserNotification'])

    def backwards(self, orm):
        db.delete_table(u'core_usernotification'),

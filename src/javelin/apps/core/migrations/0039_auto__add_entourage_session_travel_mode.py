...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column(u'core_entouragesession',
                      'travel_mode', self.gf('django.db.models.fields.CharField')(default='U', max_length=1)),

    def backwards(self, orm):
        db.delete_column(u'core_entouragesession', 'travel_mode')

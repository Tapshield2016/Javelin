...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgencyUser.device_type'
        db.add_column(u'core_agencyuser', 'device_type',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgencyUser.device_type'
        db.delete_column(u'core_agencyuser', 'device_type')

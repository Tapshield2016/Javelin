...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatMessage.message_id'
        db.add_column(u'core_chatmessage', 'message_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChatMessage.message_id'
        db.delete_column(u'core_chatmessage', 'message_id')

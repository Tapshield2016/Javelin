...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialCrimeReport.report_type'
        db.add_column(u'core_socialcrimereport', 'report_type',
                      self.gf('django.db.models.fields.CharField')(default='O', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialCrimeReport.report_type'
        db.delete_column(u'core_socialcrimereport', 'report_type')

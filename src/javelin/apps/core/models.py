...
class SocialCrimeReport(TimeStampedModel):
    ...
    report_audio_url = models.S3URLField(max_length=255, null=True, blank=True,
                                         help_text="Location of asset on S3")
    report_image_url = models.S3URLField(max_length=255, null=True, blank=True,
                                         help_text="Location of asset on S3")
    report_video_url = models.S3URLField(max_length=255, null=True, blank=True,
                                         help_text="Location of asset on S3")

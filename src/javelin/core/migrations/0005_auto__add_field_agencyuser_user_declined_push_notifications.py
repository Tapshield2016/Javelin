...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgencyUser.user_declined_push_notifications'
        db.add_column(u'core_agencyuser', 'user_declined_push_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgencyUser.user_declined_push_notifications'
        db.delete_column(u'core_agencyuser', 'user_declined_push_notifications')

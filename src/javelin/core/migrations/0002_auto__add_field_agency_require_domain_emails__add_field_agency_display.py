...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.require_domain_emails'
        db.add_column(u'core_agency', 'require_domain_emails',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Agency.display_command_alert'
        db.add_column(u'core_agency', 'display_command_alert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.require_domain_emails'
        db.delete_column(u'core_agency', 'require_domain_emails')

        # Deleting field 'Agency.display_command_alert'
        db.delete_column(u'core_agency', 'display_command_alert')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.show_agency_name_in_app_navbar'
        db.add_column(u'core_agency', 'show_agency_name_in_app_navbar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.show_agency_name_in_app_navbar'
        db.delete_column(u'core_agency', 'show_agency_name_in_app_navbar')

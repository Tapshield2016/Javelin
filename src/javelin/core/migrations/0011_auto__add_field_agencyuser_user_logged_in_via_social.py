...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgencyUser.user_logged_in_via_social'
        db.add_column(u'core_agencyuser', 'user_logged_in_via_social',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgencyUser.user_logged_in_via_social'
        db.delete_column(u'core_agencyuser', 'user_logged_in_via_social')

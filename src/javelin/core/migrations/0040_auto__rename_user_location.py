...
class Migration(SchemaMigration):
    ...
    #         'last_reported_time':
        db.rename_column(u'core_agencyuser', 'last_reported_latitude', 'latitude'),
        db.rename_column(u'core_agencyuser', 'last_reported_longitude', 'longitude'),
        db.rename_column(u'core_agencyuser', 'last_reported_point', 'location_point'),
        db.rename_column(u'core_agencyuser', 'last_reported_time', 'location_timestamp'),

        db.add_column(u'core_agencyuser',
        ...
        db.add_column(u'core_agencyuser',
                      'floor_level', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),

        db.add_column(u'core_alertlocation',
                      'floor_level', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),

    def backwards(self, orm):
        # Rename 'full_name' field to 'name'
        db.rename_column(u'core_theme', 'latitude', 'last_reported_latitude'),
        db.rename_column(u'core_theme', 'longitude', 'last_reported_longitude'),
        db.rename_column(u'core_theme', 'location_point', 'last_reported_point'),
        db.rename_column(u'core_theme', 'location_timestamp', 'last_reported_time'),

        db.delete_column(u'core_theme', 'accuracy'),
        db.delete_column(u'core_theme', 'altitude'),
        db.delete_column(u'core_theme', 'floor_level'),
        db.delete_column(u'core_theme', 'floor_level'),

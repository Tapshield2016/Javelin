...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.spot_crime_days_visible'
        db.add_column(u'core_agency', 'spot_crime_days_visible',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default = 1))

    def backwards(self, orm):
        # Deleting field 'Agency.spot_crime_days_visible'
        db.delete_column(u'core_agency', 'spot_crime_days_visible')

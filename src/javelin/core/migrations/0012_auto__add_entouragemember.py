...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntourageMember'
        db.create_table(u'core_entouragemember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entourage_members', to=orm['core.AgencyUser'])),
        ...
        db.send_create_signal(u'core', ['EntourageMember'])


    def backwards(self, orm):
        # Deleting model 'EntourageMember'
        db.delete_table(u'core_entouragemember')

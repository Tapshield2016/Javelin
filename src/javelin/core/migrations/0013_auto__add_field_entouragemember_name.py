...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntourageMember.name'
        db.add_column(u'core_entouragemember', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntourageMember.name'
        db.delete_column(u'core_entouragemember', 'name')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agency.loop_alert_sound'
        db.add_column(u'core_agency', 'loop_alert_sound',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agency.loop_alert_sound'
        db.delete_column(u'core_agency', 'loop_alert_sound')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AgencyUser.disarm_code'
        db.alter_column(u'core_agencyuser', 'disarm_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'AgencyUser.disarm_code'
        db.alter_column(u'core_agencyuser', 'disarm_code', self.gf('django.db.models.fields.CharField')(default=0, max_length=10))
